...
from table import app,db,Users,Students
from werkzeug.security import generate_password_hash
from getData import (get_faculty_info,get_students_info,research_teaching_info,
...
@app.route('/research_achievements')
...
def login():
    if request.method == 'POST':
        ...
        if user and user.check_password(password):
            ...
            return redirect(url_for('user_index'))  # 确保用户登录后重定向到 'user_index' 页面
